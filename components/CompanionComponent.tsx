...
const CompanionComponent = ({ companionId, subject, topic, name, userName, userImage, style, voice}: CompanionComponentProps) => {
  ...
  const toggleMicrophone = () => {
    if (!vapi) {
      console.error("Vapi call object is not ready yet");
      return;
    }
    ...
    <section className="flex flex-col h-[70vh]">
        <section className="flex gap-8 max-sm:flex-col">
            ...
            <div className="user-section">
                <div className="user-avatar" style={{ backgroundColor: getSubjectColor(subject)}}>
        ...
        <section className="transcript flex flex-col flex-1 min-h-[200px] overflow-y-auto">
            <div className="transcript-message no-scrollbar flex flex-col gap-2">
